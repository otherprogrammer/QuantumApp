...
dependencies {
    ...
    implementation("androidx.navigation:navigation-compose:2.7.7") //para navegacion entre pantallas
    implementation("androidx.lifecycle:lifecycle-viewmodel-compose:2.7.0") //para patron MVVM
    implementation("androidx.lifecycle:lifecycle-runtime-compose:2.7.0") //para patron MVVM
